...
public class Company {
	...
	@Produces("application/json")
	public HashSet<Coupon> getAllCouponsbyDate(
	...
	@Produces("application/json")
	public HashSet<Coupon> getAllCouponsbyPrice(@PathParam("price") double price) {
	...
	@Produces("application/json")
	public HashSet<Coupon> getAllCouponsbyType(@PathParam("type") CouponType type) {
